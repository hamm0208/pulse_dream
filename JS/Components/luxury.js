...
const Luxury = {
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="price-input-container">
                    <div class="price-input">
                      <div class="price-field">
                        ...
                        <input type="number" class="min-input" value='5000' v-model.number="Filter.minPrice" readonly>
                      </div>
                      <div class="price-field">
                        <span class="text-light">Maximum Price</span>
                        <input type="number" class="max-input" value='9000' v-model.number="Filter.maxPrice" readonly>
                      </div>
                    </div>
                  ...
                  <div class="range-input">
                    <input type="range" class="min-range" min="5000" max="9000" v-model.number="Filter.minPrice">
                    <input type="range" class="max-range" min="5000" max="9000" v-model.number="Filter.maxPrice">
                  </div>
                </div>
              </div>
            </div>
            <div v-for="car in filterCar" class="col-lg-5 col-md-9 mx-5 mx-auto">
                    <div class="img-container car-card">
                        <div class="front-card bg-light">
                            ...
                            <img :src="'Image/' + car.image" :alt="car.name" class="car_img  mx-auto">
                        </div>
                        <div class="back-card">
    ...
    data() {
      return {
        Filter: { name: '', transmission: 'All', minPrice: 5000, maxPrice: 9000 },
        luxuryCar: []
      };
    },
    computed: {
      filterCar() {
        return this.luxuryCar.filter(car =>
    ...
    mounted() {
      ...
      fetch('JS/JSON/luxury.json').then(response => response.json()).then(data => {
        this.luxuryCar = data
        console.log(this.luxuryCar)
      })
    },
    methods: {
      initRangeSliders() {
