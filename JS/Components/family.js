const Family = {
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="price-input-container">
                    <div class="price-input">
                      <div class="price-field">
                        ...
                        <input type="number" class="min-input" value='800' v-model.number="Filter.minPrice" readonly>
                      </div>
                      <div class="price-field">
                        <span class="text-light">Maximum Price</span>
                        <input type="number" class="max-input" value='3800' v-model.number="Filter.maxPrice" readonly>
                      </div>
                    </div>
                  ...
                  <div class="range-input">
                    <input type="range" class="min-range" min="800" max="3800" v-model.number="Filter.minPrice">
                    <input type="range" class="max-range" min="800" max="3800" v-model.number="Filter.maxPrice">
                  </div>
                </div>
              </div>
            </div>
    ...
    data() {
      return {
        Filter: { name: '', transmission: 'All', minPrice: 800, maxPrice: 3800 },
        familyCar: [
    ...
    computed: {
      filterCar() {
        return this.familyCar.filter(car =>
    ...
    mounted() {
      ...
      fetch('JS/JSON/family.json').then(response => response.json()).then(data => {
        this.familyCar = data
        console.log(this.familyCar)
      })
    },
    methods: {
      initRangeSliders() {
